...
describe('WalletController', () => {
  ...
  describe('generateAccountNumber', () => {
    it('should generate account number', () => {
        const accountNumber = UserController.generateAccountNumber();
  ...
  describe('createWallet', () => {
    ...
    describe('Positive Scenarios', () => {
      it('should successfully create a wallet', async () => {
        ...
        await UserController.createWallet(mockedRequest as AuthRequest, mockedResponse as Response);
  ...
  describe('deleteWallet', () => {
    ...
    describe('Positive Scenarios', () => {
      it('should successfully delete own wallet', async () => {
        ...
        await UserController.deleteWallet(mockedRequest as AuthRequest, mockedResponse as Response);
  ...
  describe('updateWalletStatus', () => {
    ...
    describe('Positive Scenarios', () => {
      it('should successfully update wallet status', async () => {
        ...
        await UserController.updateWalletStatus(mockedRequest as AuthRequest, mockedResponse as Response);
